...
class ExamExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExamExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
...
class _ExpansionTileState extends State<ExamExpansionTile>
  ...
  Widget _buildChildren(BuildContext context, Widget child) {
    ...
    final BorderRadius borderRadius = widget.borderRadius ?? boxy;
